...
import '../componentes//PaletaLista/PaletaLista.css';
              ...
              <div className="PaletaListaItem" key={`PaletaListaItem-${index}`}>
                ...
                <div>
                        ...
                        <div className="PaletaListaItem__acoes Acoes">
                          <button className={`Acoes__adicionar ${!paletaSelecionada[index] && "Acoes__adicionar--preencher"}`} onClick={() => adicionarItem(index)}>adicionar</button></div>
